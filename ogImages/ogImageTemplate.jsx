<div
    style={{
        ...
        backgroundImage:
            'radial-gradient(circle at 25px 25px, rgba(208,83,0,0.2) 2%, transparent 0%), radial-gradient(circle at 75px 75px, rgba(113,135,47,0.1) 2%, transparent 0%)',
...
>
    {/* Bordered inner container with neo-brutalistic shadow */}
    <div
        style={{
            width: '100%',
            border: '2px solid rgb(208,83,0)',
            borderRadius: '8px',
            // A crisp shadow only on the bottom and right (no blur)
            boxShadow: '8px 8px 0 0 rgb(113,135,47)',
            backgroundColor: 'rgb(208,83,0,0.05)',
            display: 'flex',
            padding: '10px',
            flexDirection: 'column',
            alignItems: 'center',
    ...
    >
        ...
        <div
            style={{
                ...
                letterSpacing: '2px',
                backgroundColor: "rgba(208,83,0,0.5)",
                color: 'black',
                border: '4px solid rgb(208,83,0)',
                padding: '10px 20px',
                marginTop: '30px',
                lineHeight: 1.2,
                whiteSpace: 'pre-wrap',
        ...
        <div
            style={{
                ...
                padding: '0px 20px',
                margin: '20px 80px',
                borderLeft: '6px solid black', // Added left border
            }}
        >
